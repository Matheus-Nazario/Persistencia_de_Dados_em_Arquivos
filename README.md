...
Nesse repositorio tem todos os programas para maximizar os seus estudos e conceito sobre manipulação de aquivos realizar a integração com o seu programa em Python 🐍 ⚡🔥
...
- [work_list](https://github.com/Matheus-Nazario/Persistencia_de_Dados_em_Arquivos/blob/main/work_list.py) </br>`  Work list é uma lista de cada processo de manipulçao de arquivo`
